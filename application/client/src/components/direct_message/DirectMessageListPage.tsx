...
import { formatRelativeTimeJa } from "@web-speed-hackathon-2026/client/src/utils/format_date";
      ...
      {error != null ? (
        ...
        <ul data-testid="dm-list">
          {conversations.map((conversation) => {
            ...
            const hasUnread = (conversation as Models.DirectMessageConversation & { hasUnread?: boolean }).hasUnread
